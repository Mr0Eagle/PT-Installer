...
panel() {
  bash <(curl -s https://raw.githubusercontent.com/Mr0Eagle/PT-Installer/$SCRIPT_VERSION/panel-install.sh)
}

wings() {
  bash <(curl -s https://raw.githubusercontent.com/Mr0Eagle/PT-Installer/$SCRIPT_VERSION/daemon-install.sh)
}
